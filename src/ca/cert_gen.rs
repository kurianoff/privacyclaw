...
fn build_certified_key(domain: &str, ca: &CaBundle) -> Result<CertifiedKey> {
    ...
    ca_params.distinguished_name.push(DnType::OrganizationName, "Privacyclaw Privacy Proxy");
    ca_params.distinguished_name.push(DnType::CommonName, "Privacyclaw Root CA");
